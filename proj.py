...
# print('Прил. 3скл. 3 оконч. м.р. ед.ч.:',res29,'\n',
...
def craft_diction_forms(dec1_Sg, dec1_Pl, dec2_m_Sg,dec2_m_Pl, dec2_n_Sg, dec2_n_Pl, dec3_1end_mf_Sg, dec3_1end_n_Sg,
    ...
    arr_12dec_Sg_Pl = []
    arr_12dec_Sg_Pl.extend([dec1_Sg, dec2_m_Sg, dec1_Pl, dec2_m_Pl, dec2_n_Sg, dec2_n_Pl])
    m_as_keys = []
    for m_forms in dec2_m_Sg:
        m_form = (m_forms[0][0])
        m_as_keys.append(m_form)
    dict_12dec = dict((key, value) for (key, value) in zip(m_as_keys, arr_12dec))
